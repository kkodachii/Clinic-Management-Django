# Generated by Django 5.1.3 on 2024-12-31 04:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('nurse', 'Nurse'), ('dentist', 'Dentist'), ('physician', 'Physician'), ('patient', 'Patient')], max_length=20, null=True)),
                ('middle_name', models.CharField(blank=True, max_length=50, null=True)),
                ('profile_picture', models.ImageField(blank=True, default='profile_pictures/default.png', null=True, upload_to='profile_pictures/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='medical_records', to='my_app.patientaccount')),
            ],
        ),
    ]
